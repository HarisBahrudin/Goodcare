...
class AdmUserEdit extends StatefulWidget {
  final VoidCallback xreload;
  final String xid, xnm, xjk, xalamat, xtlp, xemail, xrole, xtkn;
  const AdmUserEdit({ Key? key, required this.xid, required this.xreload, required this.xtkn, required this.xnm, required this.xjk, required this.xalamat, required this.xtlp, required this.xemail, required this.xrole}) : super(key: key);

  @override
  _AdmUserEditState createState() => _AdmUserEditState();
}

class _AdmUserEditState extends State<AdmUserEdit> {

  final _key = new GlobalKey<FormState>();
  String nm='', alamat='', tlp='', email='', role='Admin', jk='L';
  ...
  void initState() {
    ...
    role = widget.xrole;// == "Kasir" ? "kasir".tr() : widget.xrole;
    jk = widget.xjk;
  }
  ...
  void savePasien() async {
    ...
    try {
      final respon = await http.post(Uri.parse(MyApi.apiUserUpp), body: {'id':widget.xid, 'nm':nm, 'jk':jk, 'alamat':alamat, 'tlp':tlp, 'email':email, 'role':role}, headers: {'Authorization':widget.xtkn});
              ...
              child: ListView(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text('Role', style: TextStyle(color: Colors.purple)),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
